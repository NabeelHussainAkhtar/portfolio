        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Nabeel Akhtar" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-cyan-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I'm Nabeel Akhtar, a Java Full Stack Developer & AI Builder based in Bengaluru. I specialize in building scalable microservices and visually stunning user experiences with a focus on modern engineering and aesthetic design. With experience in building complex SuperApps and enterprise-grade backends, I'm committed to delivering impactful digital solutions."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      7.2<span className="text-cyan-500">/10</span>
                    </h1>
                    <p>CGPA</p>
                  </div>
                </div>
                ...
                <ShinyText
                  ...
                  disabled={false}
                  speed={3}
                  className="text-sm md:text-base text-cyan-400 block"
                />
              </div>
            </div>
