    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/NabeelHussainAkhtar"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://linkedin.com/in/nabeel-hussain-akhtar-b66a55227"><i className="ri-linkedin-box-fill ri-2x"></i></a>
          <a href="mailto:nabeelhussain2k02@gmail.com"><i className="ri-mail-fill ri-2x"></i></a>
        </div>
