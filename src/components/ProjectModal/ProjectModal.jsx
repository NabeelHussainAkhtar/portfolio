...
import { FiX, FiGithub } from 'react-icons/fi'; // Install react-icons if you haven't: npm install react-icons
...
const ProjectModal = ({ isOpen, onClose, project }) => {
  ...
  const handleClose = () => {
    setIsClosing(true);
    // Wait for animation to complete (300ms) before calling onClose from props
    setTimeout(() => {
      onClose();
